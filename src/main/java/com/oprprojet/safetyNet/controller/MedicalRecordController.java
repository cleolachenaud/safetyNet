...
public class MedicalRecordController {
	...
	/**
	 * controller qui permet de supprimer un medicalRecord avec en clé firstName et
	 * lastName
	 * 
	 * @param medicalRecord
	 * @return
	 */
	public ResponseEntity<MedicalRecord> deleteMedicalRecord(@PathVariable String firstName,
	...
	@PutMapping
	/**
	 * controller qui permet de mettre à jour un medicalRecord sauf firstName et
	 * lastName
	 * 
	 * @param medicalRecord
	 * @return
