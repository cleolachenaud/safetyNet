...
public class PersonController {
	...
	@PutMapping
	/**
	 * controller qui permet de mettre à jour une Person. firstName et lastName sont
	 * les points d'entrée et ne peuvent être modifiés Seuls les champs address,
	 * city, zip, phone, email le peuvent
	 * 
	 * @param person
	 * @return
	 */
