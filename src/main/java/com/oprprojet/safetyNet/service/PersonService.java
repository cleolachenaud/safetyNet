...
public class PersonService {
	...
	public Person addPerson(Person person) throws Exception {
		...
		for (Person personElement : personList) {
			if (personElement.equals(person)) {
				...
				logger.warn(
						"methode addPerson : la Person que vous essayez d'ajouter existe déjà, elle ne sera pas ajoutée");
				break;
			}
		}
	...
	/**
	 * Permet de modifier les informations d'une personne (sauf firstName et
	 * lastName)
	 */
	public Person updatePerson(Person person) throws Exception {
		...
		for (Person personElement : personList) {
			if (!personElement.getFirstName().equals(person.getFirstName())
					&& !personElement.getLastName().equals(person.getLastName())) {
				continue;
			}
